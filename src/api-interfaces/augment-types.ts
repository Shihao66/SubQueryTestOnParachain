...
import type { Account, CID, ClassIdOf, ClassType, DataSource, EthAddress, HashByte32, Properties, QueryKey, TokenId, TokenIdOf, Transaction } from 'parachainSubQ/api-interfaces/kitties';
